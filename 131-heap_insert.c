...
{
heap_t *tree, *fresh, *flip;
int lent, leaves, sub, bit, level, tmp;
...
leaves & 1 ? (tree->right = fresh) : (tree->left = fresh);
...
/* Flip values with parent until parent value exceeds fresh value */
